  ...
  <div class="container w-3/4 mx-auto p-4">
    <div class="bg-white border border-gray-200 p-4">
      <form class="flex flex-col items-start gap-4" @submit.prevent="onFormSubmit">
        <input v-model="newPost.title" type="text" placeholder="Title" class="p-4 border border-gray-200 w-full">
        ...
        <textarea v-model="newPost.content" placeholder="Content" class="p-4 border border-gray-200 w-full"></textarea>
